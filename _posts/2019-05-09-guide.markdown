...
![alt text](../assets/images/1.PNG "Image failed to load")
...
![alt text](../assets/images/2.PNG "Image failed to load")
...
![alt text](../assets/images/3.PNG "Image failed to load")

At the summary page, hit "Join network". Wola! You just created your own Ethereum node.
![alt text](../assets/images/4.PNG "Image filed to load")
...
![alt text](../assets/images/6.PNG "Image failed to load")
