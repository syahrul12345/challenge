...
![alt-text](https://syahrul12345.github.io/challenge/assets/images/createnode.gif)
...
I hope that this tutorial has helped you appreciate how easy it is to deploy smart contract using a popular framework such as Embark along with Chainstack's quick node deployment.
